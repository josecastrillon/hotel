        ...
        public function run()
        {
                ...
                if ($this->display_months)
                {
                        ...
                        for ($i = 1; $i <= 12; $i++)
                        {
                                ...
                                $month_values[$i] = strftime($this->month_value_format , mktime(0, 0, 0, $i, 1, 2000));
                        }
                        ...
                        $month_result .= $this->html_options(
                                                              array(
                                                                    'output'     => $month_names,
                                                                    'values'     => $month_values,
                                                                    'selected'   => (int)$this->time[1] ? strftime($this->month_value_format, mktime(0, 0, 0, (int)$this->time[1], 1, 2000)) : '',
                                                                    'print_result' => false
                                                                   )
                                                            );
                        $month_result .= '</select>';
